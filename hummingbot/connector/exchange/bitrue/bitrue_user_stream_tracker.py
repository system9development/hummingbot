...
class BitrueUserStreamTracker(UserStreamTracker):
    ...
    def __init__(
        self,
        bitrue_auth: Optional[BitrueAuth] = None,
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = BitrueAPIUserStreamDataSource(bitrue_auth=self._bitrue_auth)
